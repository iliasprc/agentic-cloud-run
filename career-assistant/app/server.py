...
bucket_name = f"gs://{project_id}-career-assistant-logs-data"
...
agent_name = os.environ.get("AGENT_ENGINE_SESSION_NAME", "career-assistant")
...
app.title = "career-assistant"
app.description = "API for interacting with the Agent career-assistant"
